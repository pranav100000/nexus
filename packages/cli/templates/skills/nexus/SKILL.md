---
name: nexus
description: Run Nexus AI code review agents on your repository
argument-hint: "[action] [options]"
---

# Nexus Code Review

Run Nexus to perform AI-powered code review on the current repository. Nexus orchestrates multiple specialized agents (security, performance, test coverage) to analyze code changes.
